...
__device__ void EnforceWallBoundary(float& normalVelocity, float& tangentialVelocityA, float& tangentialVelocityB, int nodeCoordinate, int gridSizeInCells, float tangentialScale);
#endif
