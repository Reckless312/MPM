...
__global__ void RebuildMappingKernel(const ParticleBlock* particleBlocks, const int particleCount, const HashTable &blockCodeToIndex, uint32_t* nextBlockIndex, uint64_t* blockCodes, const float cellSize)
{
